...
| Vesting de recompensas | 30 dias a partir do timestamp do bloco |
...
| Preço Genesis | $0,10 USDC |
| Aporte mínimo | $100 USDC (= 1.000 PLG-G) |
| Lock-up | 30 dias do timestamp do vértice |
| Pagamento | USDC na rede Polygon |
| Tokens não vendidos | Queimados automaticamente |

### Tiers Genesis

| Tier | Saldo PLG-G | Aporte | Boost de Mineração | Mineradores |
|---|---|---|---|---|
| **MASTER** | ≥ 10.000 | $1.000+ | 2,0× | até 10 |
| **SENTINELA** | 5.000–9.999 | $500–$999 | 1,5× | até 9 |
| **APOIADOR** | 1.000–4.999 | $100–$499 | 1,0× | até 4 |
...
- Genesis Reserve com tiers MASTER/SENTINELA/APOIADOR
...
*PLEGMA DAG Litepaper v1.0 — Março 2026*
